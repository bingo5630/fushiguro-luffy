...
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002449243272"))

#OWNER ID --⚠️ REQUIRED--
OWNER_ID = int(os.environ.get("OWNER_ID", "6586546549"))
...
DB_NAME = os.environ.get("DATABASE_NAME", "LX-File-Share")

TG_BOT_WORKERS = int(os.environ.get("TG_BOT_WORKERS", "4"))

#Collection of pics for Bot // #Optional but atleast one pic link should be replaced if you don't want predefined links
PICS = (os.environ.get("PICS", "https://graph.org/file/9e0becef35fddec6e82f0-ba8cfb559340a868ed.jpg")).split() #Required
